...
### <a name="vocab-meta-data-element-kwt"></a>Keywords applicable to TABLE and COLUMNS
...
### <a name="vocab-meta-data-element-kwc"></a>Keywords applicable only to COLUMNS
...
### <a name="vocab-meta-data-element-kwt"></a>Keywords applicable only to TABLE

<!-- domain -->
####  <a name="vocab-meta-data-logical-kw-domain"></a>domain
The value of this keyword MUST be a `string`.

The `domain` keyword specifies the domain to which the data asset belongs. 
